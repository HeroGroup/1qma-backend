...
exports.askAI = async (question, numberOfAnswers = 3) => {
	try {
		const content = `به سوال زیر به عنوان ${numberOfAnswers} انسان متفاوت از هم با سطح سواد عادی و تا حدودی عمیق با لحنی کاملا دوستانه و عامیانه جواب بده و جواب ها رو با مجموعه کاراکتر "-!-" از هم جدا کن.
		${question}
